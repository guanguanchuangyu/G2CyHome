...
{
    /// <summary>
    /// MySql-DeviceDbContext迁移模块
    /// </summary>
    [DependsOnPacks(typeof(MySqlEntityFrameworkCorePack))]
    [Description("MySql-DeviceDbContext迁移模块")]
    public class MySqlDeviceDbContextMigrationPack : MigrationPackBase<DeviceDbContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        protected override DeviceDbContext CreateDbContext(IServiceProvider scopedProvider)
        {
            return new DesignTimeDeviceDbContextFactory(scopedProvider).CreateDbContext(new string[0]);
        }
    }
}
