...
namespace G2CyHome.EntityConfiguration.Systems
{
    ...
    /// 实体配置类：标签管理信息
    /// </summary>
    public partial class LabelConfiguration : EntityTypeConfigurationBase<Label, int>
    {
        /// <summary>
        /// 重写以实现实体类型各个属性的数据库配置
        /// </summary>
        ...
        {
              //表名
              builder.ToTable("label").HasComment("标签管理");
              // 列名
              builder.Property(x => x.Id).HasColumnName("id").HasComment("唯一标识");
              builder.Property(x => x.Name).HasColumnName("name").HasComment("标签名称");
